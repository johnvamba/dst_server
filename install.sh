...
"$steamcmd_dir/steamcmd.sh" +@ShutdownOnFailedCommand 1 +@NoPromptForPassword 1 +login anonymous +force_install_dir "$install_dir" +app_update 343050 validate +quit
